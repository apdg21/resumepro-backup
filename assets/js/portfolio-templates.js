// Portfolio Templates JavaScript - Isolated with IIFE
(function() {
    'use strict';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ============ PREVENT CONFLICTS WITH HEADER ============
        // Make sure our event listeners don't interfere with header
        document.addEventListener('click', function(e) {
            // If click is inside portfolio-specific elements, don't let it bubble to header
            if (e.target.closest('.faq-item') || 
                e.target.closest('.template-card-portfolio') ||
