...
const ALLOWED_MODELS = new Set([
  "gemini-3.5-flash",       // recommended default — verify exact id in your AI Studio dashboard
  "gemini-3.1-flash-lite"   // fastest / cheapest — verify exact id in your AI Studio dashboard
]);
