document.addEventListener('DOMContentLoaded', function() {
    ...
    const sidebar = getElementSafe('main-nav');
    ...
    function populatePortfolio(data) {
        ...
        if (data.hero) {
            ...
            const heroSection = getElementSafe('hero');
            if (heroSection && data.hero.bgColor) {
                heroSection.style.background = data.hero.bgColor;
            }
        }
